      ...
      <div class="min-w-0 flex-1">
        <div class="flex items-start justify-between gap-2">
          ...
          <span
            ...
            class="flex-shrink-0 rounded-badge bg-surface-3 px-2 py-0.5 text-xs text-fg-muted"
          >
            Private
          </span>
        </div>

        <p v-if="location" class="mt-1 truncate text-sm text-fg-muted">
          {{ location }}
        </p>

        <div class="mt-2 flex items-center gap-3">
          <span class="flex items-center gap-1 text-sm text-fg">
