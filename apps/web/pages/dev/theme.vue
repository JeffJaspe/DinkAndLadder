    ...
    <div class="mx-auto max-w-5xl space-y-10">
      ...
      <section class="space-y-3">
        ...
        <div class="space-y-2 rounded-card border border-border bg-surface p-5 shadow-card">
          <p class="font-display text-heading-1">Heading 1 — Lexend 32 SemiBold</p>
          <p class="font-display text-heading-2">Heading 2 — Lexend 24 Medium</p>
          <p class="font-display text-heading-3">Heading 3 — Lexend 20 Medium</p>
